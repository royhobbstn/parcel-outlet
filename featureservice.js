...
// const url = 'https://services.arcgis.com/yygmGNIVQrHqSELP/arcgis/rest/services/SLOparcles/FeatureServer/0/query?outFields=*&where=1%3D1';

const url = 'https://gis.crcog.org/arcgis/rest/services/RegionalParcelViewer/Parcel_poly_Cached/MapServer/';
...
service.pages(function (err, pages) {
  ...
  pages.forEach((page, index) => {
    ...
    queue.push(axios.get(geojsonUrl)
